# Main application section: title, stats, filters, actions, grid, and log.
...
# Creates the main content panel with title, stats, filters, action buttons, application grid, and log box.
function New-KapselMainContent {
    ...
    [void] $main.RowStyles.Add((New-Object System.Windows.Forms.RowStyle([System.Windows.Forms.SizeType]::Absolute, 150)))
    ...
    [void] $filterPanel.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 50)))
    [void] $filterPanel.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Absolute, 110)))
    [void] $filterPanel.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Absolute, 120)))
    ...
    $filterPanel.Controls.Add($fossOnly, 1, 0)
    $filterPanel.Controls.Add($refreshButton, 2, 0)
    ...
    $selectAllButton = New-KapselButton -Text 'Select all visible'
    ...
    $logBox.Font = New-KapselFont -Size 8.5
